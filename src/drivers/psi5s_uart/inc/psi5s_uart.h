...
#ifndef __PSI5S_UART_H_
#define __PSI5S_UART_H_

#include <stdint.h>
#include <stddef.h>
#include <linflexd_uart.h>

/* UART Base Address (PSI5S) */
...
typedef struct Psi5s_Uart bao_uart_t;


/** Public PSI5S UART interfaces */

void psi5_uart_disable(volatile struct Psi5s_Uart * ptr_uart);
void psi5_uart_enable(volatile struct Psi5s_Uart * ptr_uart);
void psi5_uart_set_baud_rate(volatile struct Psi5s_Uart * ptr_uart, uint32_t baud_rate);
